...
const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      { icon: "🛡️", label: "Antibacterial" },
      { icon: "🌬️", label: "Alcohol-Free" },
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <Text className="max-w-3xl mx-auto text-gray-500 text-sm lg:text-base">
            Discover our latest creation designed with care and innovation.
            Experience a new way to refresh your daily routine with quality you
            can trust.
          </Text>
        </motion.div>
