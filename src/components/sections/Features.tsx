        ...
        >
          <motion.div variants={ANIMATION_VARIANTS.fadeInUp}>
            ...
            <Text variant="lead" className="max-w-3xl mx-auto text-foreground/70 text-base lg:text-lg">
              Experience a new level of personal care designed to bring out your
              natural confidence. Every product is thoughtfully crafted blending
              quality, innovation, and safety to give you the best daily
              experience.
            </Text>
          </motion.div>
        </motion.div>

        {/* Desktop Scattered Layout / Mobile Stack */}
        <div className="relative">
          {/* Mobile: Stacked Layout */}
          <div className="lg:hidden space-y-6">
            {/* Top Left Card - Trusted Quality */}
            <motion.div
            ...
            {/* Top Right Card - Natural Ingredients */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Bottom Left Card - Meaningful Innovation */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* Bottom Right Card - Safe & Reliable */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
          ...
          {/* Desktop: Scattered Cards Layout */}
          <div className="hidden lg:block relative min-h-[700px]">
            ...
            {/* Bottom Left Card - Meaningful Innovation with Image */}
            <motion.div
              initial={{ opacity: 0, x: -30, y: -30 }}
              whileInView={{ opacity: 1, x: 0, y: 0 }}
              viewport={{ once: true }}
