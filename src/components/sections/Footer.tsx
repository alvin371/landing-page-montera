          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-foreground">+62-21-23093070</span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-foreground">Info@monteragoup.com</span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-foreground">
                  Rukan Fresh Market No. C16 Green Lake City, Cipondoh Kota
